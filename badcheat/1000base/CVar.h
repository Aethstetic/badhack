...
public:
	...
	{
		typedef void(__thiscall* SetStringFn)(void*, const char*);
		return g_Utils->get_vfunc<SetStringFn>(this, 13)(this, str);
	}
	void SetValue(float value)
	{
		typedef void(__thiscall* OriginalFn)(void*, float);
		return g_Utils->get_vfunc<OriginalFn>(this, 15)(this, value);
	}
	void SetValue(int value)
	{
		typedef void(__thiscall* OriginalFn)(void*, int);
		return g_Utils->get_vfunc<OriginalFn>(this, 16)(this, value);
	}
	void SetValueChar(const char* name)
	{
		typedef void(__thiscall* SetNameFN)(void*, const char*);
		return g_Utils->get_vfunc<SetNameFN>(this, 14)(this, name);
	}
	void InternalSetString(const char* str)
	{
		typedef void(__thiscall* SetStringFn)(void*, const char*);
		return g_Utils->get_vfunc<SetStringFn>(this, 17)(this, str);
	}
	char* GetBaseName()
	{
		typedef char*(__thiscall* SetStringFn)(void*);
		return g_Utils->get_vfunc<SetStringFn>(this, 6)(this);
	}
	float GetFloat()
	{
		typedef float(__thiscall* SetValueFn)(void*);
		return g_Utils->get_vfunc< SetValueFn >(this, 12)(this);
	}
...
public:
	...
	void const ConsoleColorPrintf(const Color& clr, const char *pFormat, ...)
	{
		...
		g_Utils->get_vfunc<OriginalFn>(this, 25)(this, clr, buf, list);
	}
};