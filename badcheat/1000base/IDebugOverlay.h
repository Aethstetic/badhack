...
public:
	...
	{
		typedef void(__thiscall* oCapsuleOverlay)(void*, Vector&, Vector&, float&, int, int, int, int, float);
		return g_Utils->get_vfunc<oCapsuleOverlay>(this, 24)(this, mins, maxs, pillradius, r, g, b, a, duration);
	}
private:
